function Write-MP4TitleBasedOnFileName {
    [CmdletBinding()]
    param (
    ...
    process {
        ...
        $propertyWriter.WriteProperty($titlePropertyKey, $fileName)
...
function Main {
    ...
    Get-ChildItem -LiteralPath $Path -Recurse -Filter '*.mp4' | Write-MP4TitleBasedOnFileName
}
